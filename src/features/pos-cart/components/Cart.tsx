import { removeFromCart, updateCartItemQuantity } from '@features/pos-cart';
...
export const Cart: React.FunctionComponent<ICartProps> = (props) => {
  ...
  const handleCartQuantityChange = (cartItem, newQuantity) => {
    if (cartItem.quantity >= newQuantity) {
      dispatch(
        updateCartItemQuantity({
          purchase_detail_id: cartItem.purchase_detail_id,
                    ...
                    <div>
                      ...
                      <dl className="mt-0.5 space-y-px text-[10px] text-gray-600">
                        <div>
                          ...
                          <dd className="inline">$ {cartItem.salePrice}</dd>
                        </div>
                      </dl>
                    </div>

...
const SaleReceipt: React.FunctionComponent<ISaleReceiptProps> = ({ saleRecord, isLoading }) => {
  if (isLoading) {
    return (
      <div className='h-full w-full flex justify-center p-16'>
        <div
          ...
          <div className='flex items-center justify-between  gap-4'>
            ...
            <div className='text-gray-700 w-44 text-end'>
              ...
              <div className='text-sm text-gray-600'>
                Date:{' '}
                {saleRecord ? new Date(saleRecord.sale.date).toLocaleDateString('id-ID') : 'N/A'}
              </div>
            ...
            {saleRecord?.details.map((item, id) => {
              return (
                <div className='grid grid-cols-3 sm:grid-cols-5 gap-2' key={id}>
                  ...
                  <div>
                    <h5 className='sm:hidden text-xs font-medium text-gray-500 uppercase'>Price</h5>
